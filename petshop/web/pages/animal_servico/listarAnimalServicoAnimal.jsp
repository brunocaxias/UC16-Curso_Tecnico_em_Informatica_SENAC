                        ...
                        <div class="col-12 col-lg-9 col-xl-7">
                            <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                                <div class="card-body p-4 p-md-5">
                                    <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Listagem de Serviços Cadastrados</h3>
                                    <div class="mt-4"></div>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    ArrayList<AnimalServicoDTO> lista = objAnimalServicoDAO.pesquisarAnimalServicoAnimal(request.getParameter("id"));
